...
const syncInterval = ref(
  Number(syncStore.config?.auto_sync_interval_secs ?? 300),
);
    ...
    <div class="w-100" style="max-width: 640px">
      ...
      <div class="d-flex gap-5">
        ...
        <div style="min-width: 200px">
          <div class="mb-4">
            <label
              class="form-label small fw-semibold text-muted text-uppercase mb-2"
            >
              {{ $t("settings.theme") }}
            </label>
        ...
        <div class="flex-grow-1">
            ...
            <div class="mb-2">
              ...
              >
                ...
                <span v-else-if="webdavTestResult === 'ok'">
                  ...
                  {{ $t("sync.webdav_test_ok") }}
                </span>
                <span v-else>{{ $t("sync.webdav_test") }}</span>
              </button>
              <div
                v-if="webdavTestResult && webdavTestResult !== 'ok'"
          ...
          <template v-else-if="syncType === 'nextcloud'">
            ...
            <div class="mb-2">
              ...
              <div
                v-if="nextcloudTestResult && nextcloudTestResult !== 'ok'"
                class="small text-danger mt-1"
              >
                {{ nextcloudTestResult }}
              </div>
          ...
          <template v-if="syncType !== 'none'">
            <div class="d-flex align-items-center gap-2 mt-1">
              <label class="small text-muted mb-0 flex-grow-1">{{
                $t("sync.interval_label")
              }}</label>
              <select
